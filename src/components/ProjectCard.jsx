...
const ProjectBoard = () => {
    ...
    const [expandedColumns1, setExpandedColumns1] = useState(projectData1.map(() => false));

    const [selectedView, setSelectedView] = useState("table");
    const [selectedView1, setSelectedView1] = useState("table");


    const handleViewChange = (view) => {
        setSelectedView(view);
    };
    const handleViewChange1 = (view) => {
        setSelectedView1(view);
    };
    ...
    return (
        <>
            <Selection
                ...
                dropdownSelection="All Projects"
            />
            {selectedView != "list" ?
            ...
            <Selection
                ...
                dropdownSelection="All Tasks"
            />
            {selectedView1 != "list" ?
                <div className="project-board">
                    {projectData1.map((column, index) => {
                        const isExpanded = expandedColumns1[index];
                        const projectsToShow = isExpanded ? column.projects : column.projects.slice(0, 3); 
                        ...
                        return (
                            <div key={index} className="project-column">
                                ...
                                <button className="view-more" onClick={() => toggleExpand1(index)}>
                                    {isExpanded ? "Show Less" : "View More"}
                                </button>
                            </div>
                        );
